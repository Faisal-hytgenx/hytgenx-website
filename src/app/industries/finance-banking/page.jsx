...
import {
  ...
  fintechCoreServices,
  fintechWorkFlows,
} from "../../../../data/industriesData/finance";
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="relative">
            ...
            <IndustryMainSection
              pageName={"Finance / Fintech / Banking"}
              heading={
                <>
                  {" "}
                  <h2 className="text-4xl font-bold leading-snug">
                    Empowering{" "}
                    <span className="text-blue-700">Financial Innovation</span>{" "}
                    for a Smarter FutureRetailers
                  </h2>
                </>
              }
              desc={
                "Driving growth and efficiency in the financial sector with secure solutions that cater to businesses and customers alike."
              }
              industryFeatureData={fintechCoreServices}
              imageSrc={"/background/servicesPage/finance-header.png"}
          ...
          <div className="relative max-w-7xl mx-auto lg:px-20 px-10">
              ...
              <div className="grid md:grid-cols-2 gap-4 items-center">
                ...
                <div className="flex justify-center">
                  <div className="w-full flex justify-center">
                    <Image
                      src="/background/servicesPage/finance-about.png"
                ...
                <h5 className="text-xs font-semibold uppercase text-blue-700">
                  ...
                  <h2 className="text-4xl font-bold leading-snug">
                    ...
                    <span className="text-blue-700">
                      {" "}
                      Financial Services with Smart Technology
                    </span>
                  </h2>
                  <p className="text-gray-400 text-base">
                    The financial sector is rapidly evolving, and embracing
                    digital transformation is key to staying ahead. At hytGenX,
                    we harness emerging technologies such as blockchain, AI, and
                    machine learning to create smarter financial services. From
                    automating back-office processes to enhancing customer
                    interactions, our solutions help businesses achieve
                    security, efficiency, and adaptability to meet future
                    challenges.
                  </p>
                </div>
              </div>
            ...
            <div className="relative bg-glass py-12 px-8 rounded-lg shadow-xl z-10">
              ...
              <h2 className="text-center text-4xl text-white font-bold mb-12">
                Unlock the Power of{" "}
                <span className="text-blue-700 font-bold">AI</span> for Smarter
                Financial Solutions
              </h2>

              {/* Four Parts */}
              <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-8">
                {fintechCoreFeatures.map((feature, index) => (
                  <div
                    key={index}
          ...
          <div className="relative py-20">
            ...
            <p className="w-full md:w-[70%] lg:w-[50%] text-gray-400 mb-8 text-sm">
              Optimized financial workflows are essential for business growth
              and customer satisfaction. Our solutions enhance banking,
              payments, and customer service operations, reducing errors,
              accelerating transactions, and improving efficiency.
            </p>
            <div className="space-y-6">
              {fintechWorkFlows.map((industry, index) => (
                <div
                  key={index}
            ...
            <div className="relative flex flex-col items-center justify-center text-center py-16 rounded-lg mt-20 bg-glass">
              ...
              <div className="relative z-10 w-[80%] ">
                <h1 className="text-2xl sm:text-4xl text-white font-bold">
                  Unlock the Future of Finance with hytGenX
                </h1>
                <p className="mt-4 text-sm sm:text-lg text-gray-300">
                  Join the digital revolution in finance with solutions that
                  empower businesses and customers alike. Contact us today to
                  explore how we can help you shape the future of fintech and
                  banking.
                </p>
                <Link href={"/contact"}>
