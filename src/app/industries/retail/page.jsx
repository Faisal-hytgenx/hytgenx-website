...
import {
  ...
  retailCoreServices,
  retailWorkFlows,
} from "../../../../data/industriesData/retail";
        ...
        <div className="relative z-10">
              ...
              heading={
                <>
                  ...
                  <h2 className="text-4xl font-bold leading-snug">
                    Empowering <span className="text-blue-700">Retailers </span>
                    with Intelligent Solutions for a Connected Future
                  </h2>
                </>
              }
              desc={
                "Transform your retail business with customer-first solutions that enhance the shopping experience, improve operations, and boost sales."
              }
              industryFeatureData={retailCoreServices}
              imageSrc={"/background/servicesPage/retail-header.png"}
          ...
          <div className="relative max-w-7xl mx-auto lg:px-20 px-10">
            <div className="text-white py-20">
              <div className="grid md:grid-cols-2 gap-4 items-center">
                ...
                <div className="flex justify-center">
                  <div className="flex justify-center">
                    <Image
                      src="/background/servicesPage/retail-about.png"
                ...
                <h5 className="text-xs font-semibold uppercase text-blue-700">
                  ...
                  <h2 className="text-4xl font-bold leading-snug">
                    Redefining the{" "}
                    <span className="text-blue-700">Retail Experience</span>{" "}
                    with Smart Technology
                  </h2>
                  <p className="text-gray-400 text-base">
                    As the retail industry continues to evolve, staying ahead is
                    essential. By integrating technologies like AI, real-time
                    inventory tracking, and e-commerce solutions, we help
                    businesses modernize and deliver exceptional customer
                    experiences. Whether improving in-store interactions or
                    building a strong online presence, our platforms support
            ...
            <div className="relative bg-glass py-12 px-8 rounded-lg shadow-xl z-10">
              ...
              <h2 className="text-center text-4xl text-white font-bold mb-12">
                Optimize Retail Operations with Smart,{" "}
              ...
              <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-8">
                {retailCoreFeatures.map((feature, index) => (
                  <div
                    key={index}
          ...
          <div className="relative py-20">
            ...
            <h2 className="text-3xl text-white mb-4 text-start">
              Streamline{" "}
              <span className="text-blue-700  font-bold">Retail </span>Workflows
              and Maximize Efficiency
            </h2>
            <p className="w-full md:w-[70%] lg:w-[50%] text-gray-400 mb-8 text-sm">
              Our solutions help retailers enhance workflows, improve
              decision-making, and reduce operational costs. By integrating
              systems for inventory management and customer relationships, we
              create intelligent platforms that keep businesses running
              efficiently.
            </p>
            <div className="space-y-6">
              {retailWorkFlows.map((industry, index) => (
                <div
                  key={index}
            ...
            <div className="relative flex flex-col items-center justify-center text-center py-16 rounded-lg mt-20 bg-glass">
              ...
              <div className="relative z-10 w-[80%] ">
                <h1 className="text-2xl sm:text-4xl text-white font-bold">
                  Unlock Your Retail Business's Potential with hytGenX.
                </h1>
                <p className="mt-4 text-sm sm:text-lg text-gray-300">
                  Transform your retail business with technology that drives
                  growth and enhances customer experiences. Contact us today to
                  explore the possibilities for a more connected and profitable
                  future.
                </p>
                <Link href={"/contact"}>
