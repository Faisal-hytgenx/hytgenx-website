...
import {
  ...
  TechnologiesData,
  ourProcessData,
} from "../../../../data/servicesData/ai-powered";
    ...
    <LayoutWrapper>
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10">
          <MainSection
            pageName={"AI-Powered Development Solutions"}
            heading={
              <>
                Unlock the Potential of{" "}
                <span className="text-blue-700">AI</span> to Revolutionize Your{" "}
            ...
            headerImage={"/background/servicesPage/ai-powered.png"}
          />
          <div
            className="relative"
            style={{
          ...
          {/* Second Section */}
          <div
            className="max-w-7xl mx-auto lg:px-20 px-10"
            style={{
              backgroundImage: "url('/background/stars.png')",
              backgroundSize: "cover",
              backgroundPosition: "center",
            ...
            <div className="relative bg-glass flex flex-col items-center justify-center text-center py-36 rounded-lg mt-20">
              <div className="z-10 w-[80%]">
                <h1 className="text-2xl sm:text-5xl text-white font-bold">
                  ...
                  <span className="text-blue-700">AI-Powered Solutions</span>
                </h1>
                <p className="mt-4 text-sm sm:text-lg text-gray-300">
                  AI is the future, and with hytGenX, you can start harnessing
                  its power today. From automating processes to enhancing
                  decision-making, our AI development solutions will help you
                  stay ahead of the competition. Let’s create something
