...
import {
  ...
  TechnologiesData,
  ourProcessData
} from "../../../../data/servicesData/machine-learning";
    ...
    <LayoutWrapper>
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10">
          <MainSection
            pageName={"Machine Learning & AI Solutions"}
            heading={
              <>
                Unlock Business Potential with Smarter{" "}
                <span className="text-blue-700">AI Solutions</span>
              </>
            }
            desc={
              "Turn your data into actionable insights and stay ahead with AI-driven innovation."
            }
            ...
            headerImage={"/background/servicesPage/ml-service.png"}
          />
            ...
            <div className="relative bg-glass flex flex-col items-center justify-center text-center py-36 rounded-lg mt-20">
              <div className="z-10 w-[80%]">
                <h1 className="text-2xl sm:text-5xl text-white font-bold">
                  Turn AI into Your Competitive{" "}
                  <span className="text-blue-700">Advantage</span>
                </h1>
                <p className="mt-4 text-sm sm:text-lg text-gray-300">
                  From smarter predictions to streamlined operations, AI is
                  transforming how businesses operate. Let hytGenX help you
                  embrace this change with solutions designed to fit your unique
                  needs. Together, we’ll make your business future-ready.
                </p>
                <Link href={"/contact"}>
                  <button className="mt-6 px-10 py-3 bg-blue-700 text-white font-medium text-md rounded-md shadow-lg hover:bg-blue-600">
                    📞 Let’s Talk AI or 📧 Email us for a free consultation.{" "}
                  </button>
                </Link>
              </div>
            </div>
