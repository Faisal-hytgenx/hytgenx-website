...
import {
  ...
  TechnologiesData,
  ourProcessData,
} from "../../../../data/servicesData/mern.js";
    ...
    <LayoutWrapper>
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10">
          <MainSection
            pageName={"MERN Stack Development Solutions"}
            heading={
              <>
                Build Dynamic, Scalable, and High-Performance{" "}
                <span className="text-blue-700">Web Applications</span>
              </>
            }
            desc={
              "Power your business with modern, fast, and efficient web solutions using the MERN stack."
            }
            ...
            headerImage={"/background/servicesPage/mern-service.png"}
          />
            ...
            <div className="relative bg-glass flex flex-col items-center justify-center text-center py-36 rounded-lg mt-20">
              <div className="z-10 w-[80%]">
                <h1 className="text-2xl sm:text-5xl text-white font-bold">
                  Take Your{" "}
                  <span className="text-blue-700">Web Application</span> to the
                  Next Level
                </h1>
                <p className="mt-4 text-sm sm:text-lg text-gray-300">
                  Transform your vision into a functional, high-performing web
                  application with hytGenX’s MERN stack development services.
                  From concept to deployment, we’re here to deliver results that
                  drive your success.
                </p>
                <Link href={"/contact"}>
                  <button className="mt-6 px-10 py-3 bg-blue-700 text-white font-medium text-md rounded-md shadow-lg hover:bg-blue-600">
                    📞 Let’s Get Started or 📧 Email us for a free consultation.{" "}
                  </button>
                </Link>
              </div>
            </div>
