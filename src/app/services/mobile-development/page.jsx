...
import {
  ...
  TechnologiesData,
  ourProcessData,
} from "../../../../data/servicesData/mobile-app";
    ...
    <LayoutWrapper>
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10">
          <MainSection
            pageName={"Mobile App Development Solutions"}
            heading={
              <>
                Transform Ideas into Powerful{" "}
                <span className="text-blue-700">Mobile Apps</span>
              </>
            }
            desc={
              "Deliver exceptional user experiences with mobile apps designed to engage, perform, and grow with your business."
            }
            ...
            headerImage={"/background/servicesPage/mobile-service.png"}
          />
            ...
            <div className="relative bg-glass flex flex-col items-center justify-center text-center py-36 rounded-lg mt-20">
              <div className="z-10 w-[80%]">
                ...
                <p className="mt-4 text-sm sm:text-lg text-gray-300">
                  Your business deserves an app that stands out. Whether it’s a
                  fresh idea or improving an existing app, hytGenX is ready to
                  help. Let’s turn your vision into a mobile app that makes an
                  impact.
                </p>
                <Link href={"/contact"}>
                  <button className="mt-6 px-10 py-3 bg-blue-700 text-white font-medium text-md rounded-md shadow-lg hover:bg-blue-600">
                    📞 Start Building Your App or 📧 Email us for a free
                    consultation.
                  </button>
                </Link>
              </div>
